        ...
        <div className="text-center mb-8">
          ...
          <div className="max-w-2xl mx-auto mb-6">
            <div className="flex gap-3">
              <div className="flex-1 relative cursor-pointer">
                <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 h-5 w-5 cursor-pointer" />
                <Input
                  type="text"
              ...
              <Button
                ...
                className="h-14 px-6 bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 hover:from-red-600 hover:via-orange-600 hover:to-yellow-600 text-white font-bold rounded-2xl cursor-pointer"
              >
          ...
          <div className="flex justify-center gap-4 mb-6">
            <Button
              ...
              className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-orange-200 dark:border-orange-700 hover:border-orange-300 dark:hover:border-orange-600 rounded-2xl cursor-pointer"
            >
